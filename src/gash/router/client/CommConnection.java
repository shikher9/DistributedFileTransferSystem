...
public class CommConnection {
    ...
    public static CommConnection getInstance() {
        if (instance.get() != null) {
            ...
            throw new RuntimeException("CommConnection not initialized");
        }
    }
     ...
     * @return
     */
    public boolean write(CommandMessage msg) throws Exception {
        if (msg == null) {
            return false;
    ...
    private void createBootstrap(EventLoopGroup group) {
        try {
